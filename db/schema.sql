...
alter table lz_orders add column if not exists voucher numeric default 0;
alter table lz_orders add column if not exists voucher_seller numeric default 0;
alter table lz_orders add column if not exists voucher_platform numeric default 0;
alter table lz_orders add column if not exists voucher_code text;
